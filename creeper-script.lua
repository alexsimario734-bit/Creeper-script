...
-- *** SOLO LA INTERFAZ REDONDA TIENE IMAGEN ***
...
-- MENÚ PRINCIPAL (2DA INTERFAZ) - 110×110 (GRIS COMO PEDISTE)
local menu = Instance.new("Frame")
menu.Parent = gui
menu.Size = UDim2.new(0, 110, 0, 110)
menu.Position = UDim2.new(0.3, 0, 0.35, 0)
menu.BackgroundColor3 = Color3.fromRGB(60,60,60) -- gris
